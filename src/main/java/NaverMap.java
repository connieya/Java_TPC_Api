...
public class NaverMap implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        String clientId = "po0v5t31yt";
        String clientSecret = "HJOhVIE8SRGzxyPHOydT3EthxAeo3yCykBu69S8Z";
        AddressVO vo = null;
    ...
    public void map_service(AddressVO vo) {
        ...
        try {
            ...
            URL_STATICMAP += "&markers=type:t|size:mid|pos:" + pos + "|label:" + URLEncoder.encode(vo.getRoadAddress());
